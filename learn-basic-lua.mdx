---
title: Learn Basic Lua
description: A quick guide to essential Lua concepts for NyxVim configuration
---
...
-- If you don't use index or value here then you can replace it with _ 
...
-- The list tables won't merge because they don't have keys 
